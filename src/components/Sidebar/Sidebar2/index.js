      ...
      <aside className={props.className}>
        <div className="">
          <Column className="bg-white_A700 items-center justify-start lg:p-[22px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] w-[100%]">
            ...
            <Column className="justify-start lg:mb-[299px] xl:mb-[374px] 2xl:mb-[421px] 3xl:mb-[505px] lg:mt-[25px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] pt-[1px] w-[88%]">
              ...
              <Row className="items-start lg:mt-[23px] xl:mt-[29px] 2xl:mt-[33px] 3xl:mt-[39px] w-[63%]">
                <Img
                  ...
                  alt="calendar"
                />
                <Text className="rowcalendar2" as="h6" variant="h6">
                  Calender
                </Text>
              </Row>
              ...
              <Row className="items-end lg:mt-[22px] xl:mt-[27px] 2xl:mt-[31px] 3xl:mt-[37px] w-[61%]">
                ...
                <Text
                  className="font-inter font-medium mb-[2px] xl:ml-[11px] 2xl:ml-[13px] 3xl:ml-[15px] lg:ml-[9px] lg:mt-[4px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[8px] text-bluegray_800 w-[auto]"
                  as="h6"
                  variant="h6"
                >
                  Settings
