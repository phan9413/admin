      ...
      <aside className={props.className}>
        <div className="">
          <Column className="bg-white_A700 items-center justify-start lg:p-[22px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] w-[100%]">
            ...
            <Column className="justify-start lg:mb-[1028px] xl:mb-[1287px] 2xl:mb-[1448px] 3xl:mb-[1737px] lg:mt-[25px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] pt-[1px] w-[88%]">
              ...
              <Row className="items-end lg:mt-[24px] xl:mt-[30px] 2xl:mt-[34px] 3xl:mt-[40px] w-[46%]">
                <Img
                  ...
                  alt="trash"
                />
                <Text className="rowtrash5" as="h6" variant="h6">
                  Shop
                </Text>
              </Row>
