      ...
      <aside className={props.className}>
        <div className="">
          <Column className="bg-white_A700 items-center justify-start lg:p-[22px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] w-[100%]">
            ...
            <Column className="justify-start lg:mb-[383px] xl:mb-[479px] 2xl:mb-[539px] 3xl:mb-[647px] lg:mt-[25px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] pt-[1px] w-[88%]">
              ...
              <Row className="items-center lg:mt-[24px] xl:mt-[31px] 2xl:mt-[35px] 3xl:mt-[42px] w-[43%]">
                <Img
                  ...
                  alt="trash One"
                />
                <Text className="font-inter rowgrid" as="h6" variant="h6">
                  Cart
                </Text>
              </Row>
