              ...
              <Row className="font-inter items-center justify-between mb-[1px] lg:mt-[27px] xl:mt-[33px] 2xl:mt-[38px] 3xl:mt-[45px] w-[100%]">
                    ...
                    <Button
                      ...
                      rightIcon={
                        <Img
                          ...
                          className="ml-[3px] text-center lg:w-[14px] lg:h-[15px] xl:w-[17px] xl:h-[18px] 2xl:w-[20px] 2xl:h-[20px] 3xl:w-[23px] 3xl:h-[24px]"
                          alt="plus"
                        />
                      }
                ...
                <Column className="bg-white_A700 items-center lg:p-[18px] xl:p-[23px] 2xl:p-[26px] 3xl:p-[31px] rounded-radius4 shadow-bs w-[75%]">
                  ...
                  <Stack className="lg:h-[457px] xl:h-[571px] 2xl:h-[642px] 3xl:h-[771px] lg:mb-[4px] xl:mb-[5px] 2xl:mb-[6px] 3xl:mb-[7px] lg:mt-[21px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[35px] w-[99%]">
                    <Column className="absolute border border-indigo_51 border-solid bottom-[0] items-center justify-start xl:p-[107px] 2xl:p-[121px] 3xl:p-[145px] lg:p-[85px] w-[100%]">
                      <Img
                        src="images/img_19.svg"
                        className="xl:h-[106px] 2xl:h-[119px] 3xl:h-[143px] lg:h-[85px] w-[23%]"
                        alt="Nineteen"
                      />
                      <Text
                        className="lg:mb-[113px] xl:mb-[142px] 2xl:mb-[160px] 3xl:mb-[191px] lg:mt-[39px] xl:mt-[49px] 2xl:mt-[56px] 3xl:mt-[67px] rowoval"
                        as="h5"
                        variant="h5"
                      >
                        ...
                        <span className="text-indigo_400 font-inter font-medium lg:text-[11px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px]">
                          Create new
                        </span>
                      </Text>
                    </Column>
