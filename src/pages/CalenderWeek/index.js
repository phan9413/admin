            ...
            <Column className="bg-gray_51 font-poppins justify-end lg:p-[16px] xl:p-[20px] 2xl:p-[23px] 3xl:p-[27px] w-[100%]">
              ...
              <Row className="font-inter items-center justify-between mb-[1px] lg:mt-[27px] xl:mt-[33px] 2xl:mt-[38px] 3xl:mt-[45px] w-[100%]">
                ...
                <Column className="bg-white_A700 items-center lg:p-[18px] xl:p-[23px] 2xl:p-[26px] 3xl:p-[31px] rounded-radius4 shadow-bs w-[75%]">
                  ...
                  <Column className="items-center justify-start mb-[3px] lg:mt-[21px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[35px] w-[99%]">
                    <Row className="items-center w-[100%]">
                      <List
                        className="grid grid-cols-5 min-h-[auto] w-[71%]"
                        orientation="horizontal"
                      >
                        <Column className="listprofileviews_twelve">
                          <Text
                            className="columnprofileviews_twelve1"
                            as="h5"
                            variant="h5"
                          >
                            Sun 2/1
                    ...
                    <Column
                      className="bg-cover bg-repeat justify-start lg:p-[11px] xl:p-[14px] 2xl:p-[16px] 3xl:p-[19px] w-[100%]"
                      style={{
                        backgroundImage: "url('images/img_group8446.svg')",
                      }}
                    >
                      <Row className="bg-deep_orange_300 items-start lg:mb-[380px] xl:mb-[476px] 2xl:mb-[536px] 3xl:mb-[643px] 2xl:ml-[101px] 3xl:ml-[121px] lg:ml-[71px] xl:ml-[89px] lg:p-[3px] xl:p-[4px] 3xl:p-[5px] 2xl:p-[5px] rounded-radius4 w-[14%]">
                        <Row className="items-end justify-center mb-[4px] 2xl:ml-[10px] 3xl:ml-[11px] lg:ml-[7px] xl:ml-[8px] mt-[1px] w-[72%]">
                          <div className="bg-white_A700 3xl:h-[10px] lg:h-[6px] 2xl:h-[8px] xl:h-[8px] mb-[1px] lg:mt-[3px] xl:mt-[4px] 3xl:mt-[5px] 2xl:mt-[5px] rounded-radius50 lg:w-[5px] xl:w-[7px] 2xl:w-[8px] 3xl:w-[9px]"></div>
                          <Text
                            className="font-medium lg:ml-[5px] xl:ml-[7px] 2xl:ml-[8px] 3xl:ml-[9px] text-white_A700 w-[auto]"
                            as="h6"
                            variant="h6"
                          >
                            8:10 am
                        ...
                        <Text
                          className="font-normal mb-[4px] 3xl:ml-[10px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] not-italic text-white_A700 w-[auto]"
                          as="h6"
                          variant="h6"
                        >
                          Mêt
