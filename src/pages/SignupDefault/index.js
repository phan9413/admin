    ...
    <>
      <Row className="bg-red_53 font-inter items-start mx-[auto] lg:p-[40px] xl:p-[50px] 2xl:p-[57px] 3xl:p-[68px] w-[100%]">
        ...
        <Column className="bg-white_A700 items-center justify-end lg:mr-[110px] xl:mr-[138px] 2xl:mr-[156px] 3xl:mr-[187px] mt-[1px] lg:p-[24px] xl:p-[30px] 2xl:p-[34px] 3xl:p-[41px] rounded-radius20 shadow-bs1 w-[36%]">
          <Column className="items-center justify-start mt-[2px] w-[91%]">
            ...
            <Column className="justify-start lg:mt-[27px] xl:mt-[33px] 2xl:mt-[38px] 3xl:mt-[45px] w-[100%]">
              <Row
                className="common-pointer bg-white_A700 border border-indigo_51 border-solid items-center xl:p-[12px] 2xl:p-[14px] 3xl:p-[16px] lg:p-[9px] rounded-radius4 w-[93%]"
              ...
              >
                ...
                />
                <Text
                  className="font-medium lg:ml-[57px] xl:ml-[71px] 2xl:ml-[80px] 3xl:ml-[97px] text-bluegray_800 w-[auto]"
                  as="h6"
                  variant="h6"
                >
                  Sign up with Google
              ...
              <Row className="items-start justify-end ml-[auto] lg:mt-[35px] xl:mt-[44px] 2xl:mt-[50px] 3xl:mt-[60px] w-[96%]">
                <Line className="bg-indigo_51 h-[1px] lg:mt-[4px] 2xl:mt-[5px] xl:mt-[5px] 3xl:mt-[6px] w-[38%]" />
                <Text
                  className="lg:ml-[39px] xl:ml-[49px] 2xl:ml-[55px] 3xl:ml-[66px] rowline"
                  as="h6"
                  variant="h6"
                >
                  Or
                </Text>
                <Line className="bg-indigo_51 h-[1px] xl:ml-[12px] 2xl:ml-[14px] 3xl:ml-[16px] lg:ml-[9px] lg:mt-[4px] 2xl:mt-[5px] xl:mt-[5px] 3xl:mt-[6px] w-[38%]" />
              </Row>
              <Input
                className="placeholder:text-bluegray_400 email_One"
                wrapClassName="2xl:mt-[42px] 3xl:mt-[50px] flex lg:mt-[29px] w-[93%] xl:mt-[37px]"
                type="text"
                name="Textinput"
              ...
              <Input
                className="placeholder:text-bluegray_400 email_One"
                wrapClassName="2xl:mt-[43px] 3xl:mt-[52px] flex lg:mt-[31px] w-[93%] xl:mt-[38px]"
                type="email"
                name="Textinput One"
                placeholder="Email"
                prefix={
              ...
              <Input
                className="placeholder:text-bluegray_400 email_One"
                wrapClassName="2xl:mt-[35px] 3xl:mt-[42px] flex lg:mt-[25px] w-[93%] xl:mt-[31px]"
                type="password"
                name="Textinput Two"
              ...
              ></Input>
              <Text
                className="font-medium lg:leading-[12px] xl:leading-[16px] 2xl:leading-[18px] 3xl:leading-[21px] lg:ml-[29px] xl:ml-[36px] 2xl:ml-[41px] 3xl:ml-[49px] lg:mt-[46px] xl:mt-[58px] 2xl:mt-[65px] 3xl:mt-[78px] text-bluegray_800 text-center w-[70%]"
                as="h6"
                variant="h6"
              >
              ...
              <Button
                className="font-bold lg:mt-[31px] xl:mt-[39px] 2xl:mt-[44px] 3xl:mt-[53px] xl:text-[10px] 2xl:text-[11px] 3xl:text-[13px] lg:text-[8px] text-center w-[93%]"
